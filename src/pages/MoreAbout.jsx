    ...
    <section className="max-w-5xl mx-auto p-8 bg-neutral-800 text-white rounded-2xl shadow-lg mt-10 animate-fade-in shadow-glow" >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="transition-opacity duration-100 opacity-0 animate-fade-in-delay">
          ...
          Apasionado por la tecnología, con una fuerte orientación al aprendizaje continuo y al desarrollo de soluciones web interactivas. Me destaco por mi curiosidad, capacidad de análisis y compromiso con la mejora constante. Actualmente estoy trabajando en proyectos con SpringBoot, manejando API y distinstas arquitecturas de software, lo que me ha permitido fortalecer mi lógica de programación y ampliar mis conocimientos en tecnologías modernas del desarrollo backend.
          </p>
