            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 font-ubuntu">
                    ...
                    <div className="flex flex-col">
                        ...
                        <ul className="space-y-2 text-gray-300">
                            <li><a href="https://github.com/alejocoding" target="_blank" rel="noreferrer" className="hover:text-purple-300 transition">GitHub</a></li>
                            <li><a href="https://www.linkedin.com/in/alejandro-velandia-machado-967836363/" target="_blank"  rel="noreferrer" className="hover:text-purple-300 transition">LinkedIn</a></li>
                        </ul>
                    </div>
